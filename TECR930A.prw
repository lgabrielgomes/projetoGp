...
//Vari·veis para uso com os dados do pergunte
...
If Pergunte(cPergunte)
	...
	oReport := ReportDef(cPergunte, lImpImp) 
	oReport:PrintDialog()
EndIf
...
±±¿ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒŸ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ*/

Static Function ReportDef(cPergunte,lImpImp)
                                             
//Vari·veis utilizadas para geraÁ„o do Report
Local oReport 
...
Local aIdent	:= {STR0041,STR0040,STR0039,STR0042,STR0043} //'3 - Materiais de Consumo' //'2 - Materiais de ImplantaÁ„o' //'1 - Recursos Humanos' //'4 - LocaÁ„o de Equipamentos' //'5 - Despesas Adicionais'
Local nTamIdent := 0
...
oReport := TReport():New("TECR930A",STR0001,cPergunte,{|oReport| RELIMP(oReport,lImpImp,aIdent, lTWX)},"")                                                                                                                                                                                                                                                                                                                                                                                                                                    //"Anexo de Fatura"
...
oCell := TRCell():New(oSection0,"CODMED","QRYSQL","MediÁ„o"	          ,, GetSx3Cache("TFV_CODIGO", "X3_TAMANHO"),,,"LEFT",,"LEFT")//"MediÁ„o"
oCell := TRCell():New(oSection0,"CONTRT","QRYSQL","Contrato"	      ,, GetSx3Cache("TFV_CONTRT", "X3_TAMANHO")+2,,,"LEFT",,"LEFT")//"Contrato"
oCell := TRCell():New(oSection0,"SERVEXT","QRYSQL","Orc Serv"         ,, GetSx3Cache("TFV_ORCSRV", "X3_TAMANHO"),,,"LEFT",,"LEFT")//"Orc Serv"
oCell := TRCell():New(oSection0,"CODLOC","QRYSQL","Local"	          ,, GetSx3Cache("ABS_LOCAL", "X3_TAMANHO"),,,"LEFT",,"LEFT")//"CÛdigo"
oCell := TRCell():New(oSection0,"LOCDSC","QRYSQL",STR0003		      ,, GetSx3Cache("ABS_DESCRI", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"Desc. Local"
oCell := TRCell():New(oSection0,"TFV_DTAPUR","QRYSQL","Dt MediÁ„o"   ,, GetSx3Cache("TFV_DTAPUR", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"Dt MediÁ„o"
...
oCell := TRCell():New(oSection0,"CLIENTE","QRYSQL","Cliente"          ,, GetSx3Cache("C5_CLIENTE", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"Cliente"
oCell := TRCell():New(oSection0,"C5_LOJACLI" ,"QRYSQL","Loja"         ,, GetSx3Cache("C5_LOJACLI", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"Loja"
oCell := TRCell():New(oSection0,"C5_NOMCLI" ,"QRYSQL","Nome"          ,, GetSx3Cache("C5_NOMCLI", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"Nome"
...
oCell := TRCell():New(oSection1,"C6_PRODUTO","QRYSQL",STR0045		      ,,nTamProd,,,"LEFT",,"LEFT") //"CÛdigo"
oCell := TRCell():New(oSection1,"B1_DESC","QRYSQL",STR0049		      ,,nTamDescr,,,"LEFT",,"LEFT") //"DescriÁ„o Produto"
...
oCell := TRCell():New(oSection1,"C6_PRUNIT" ,"QRYSQL",GetSx3Cache("C6_PRUNIT", "X3_TITULO")	          ,GetSx3Cache("C6_PRUNIT", "X3_PICTURE"),GetSx3Cache("C6_PRUNIT", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"PreÁo Unit·rio"
oCell := TRCell():New(oSection1,"C6_SUBTOT" ,"QRYSQL","SubTotal"         ,cImpPic,nTamImp,,{|| QRYSQL->(C6_QTDVEN*C6_PRUNIT) },"LEFT",,"LEFT") //"PreÁo Unit·rio"
//oCell := TRCell():New(oSection1,"C6_PRCVEN" ,"QRYSQL",STR0050	          ,GetSx3Cache("C6_PRCVEN", "X3_PICTURE"),GetSx3Cache("C6_PRCVEN", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"PreÁo Unit·rio"

oCell := TRCell():New(oSection1,"C6_VALDESC" ,"QRYSQL",GetSx3Cache("C6_VALDESC", "X3_TITULO")        ,cImpPic,nTamImp,,,"LEFT",,"LEFT") //"PreÁo Unit·rio"
oCell := TRCell():New(oSection1,"C6_VALOR" ,"QRYSQL",STR0051	             ,cImpPic, nTamImp,,,"LEFT",,"LEFT") //"PreÁo Total"
...
oBreak := TRBreak():New( oSection1 , { ||  QRYSQL->(CODMED+NUMNF+SERIE+PEDIDO+CODLOC+ITEM) } , STR0052 , .T. , , .F.)  //"Total do Item"
	...
	oCellQbr := TRCell():New(oSection30,"IDENT","QRYSQL",""                ,,nTamIdent,,,"LEFT",,"LEFT")
		...
		oCell := TRCell():New(oSection31,"PRDCOD"	,"QRYSQL",STR0045          	,,nTamProd,,,"LEFT",,"LEFT") //"CÛdigo"
		oCell := TRCell():New(oSection31,"PRDDSC"	,"QRYSQL",STR0049			 	,,nTamDescr,,,"LEFT",,"LEFT")//DescriÁ„o //"DescriÁ„o Produto"
		...
		oCell := TRCell():New(oSection31,"TOTBON"	,"QRYSQL",STR0013		      	,GetSx3Cache("TFW_TOTBON", "X3_PICTURE"),GetSx3Cache("TFW_TOTBON", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"BonificaÁıes"
	...
	oCellQbr := TRCell():New(oSection40,"IDENT","QRYSQL",""            ,,nTamIdent,,,"LEFT",,"LEFT")
		...
		oSection41 := TRSection():New(oSection40, STR0026, /*<uTable> */, /*<aOrder>*/ , /*<lLoadCells>*/ , /*<lLoadOrder>*/ , /*<uTotalText>*/ STR0056,/*<lTotalInLine .T.*/ , /*<lHeaderPage> */.f., /*<lHeaderBreak>*/ .T. , /*<lPageBreak>*/ .F. , /*<lLineBreak>*/ ,/* <nLeftMargin>*/ 15 , /*<lLineStyle> */, /*<nColSpace>*/ , /*<lAutoSize> */, /*<cCharSeparator>*/ , /*<nLinesBefore> */, /*<nCols> */, /*<nClrBack> */, /*<nClrFore> */, /*<nPercentage> */ ) //Recursos Humanos //"Materiais de ImplantaÁ„o" //"Total Materiais de ImplantaÁ„o"
		oSection41:SetHeaderSection(.T.)
		
		oCell := TRCell():New(oSection41,"PRDCOD","QRYSQL",STR0045         	,,nTamProd,,,"LEFT",,"LEFT") //"CÛdigo"
		oCell := TRCell():New(oSection41,"PRDDSC","QRYSQL",STR0049    		,,nTamDescr,,,"LEFT",,"LEFT") //"DescriÁ„o Produto"
		...
		oCell := TRCell():New(oSection41,"TOTBON","QRYSQL",STR0013  		,GetSx3Cache("TFX_TOTBON", "X3_PICTURE"),GetSx3Cache("TFX_TOTBON", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"BonificaÁıes"
	...
	oCellQbr := TRCell():New(oSection50,"IDENT","QRYSQL",""            ,,nTamIdent,,,"LEFT",,"LEFT")
		...
		oCell := TRCell():New(oSection51,"PRDCOD","QRYSQL",STR0045         	,,nTamProd,,,"LEFT",,"LEFT") //"CÛdigo"
		oCell := TRCell():New(oSection51,"PRDDSC","QRYSQL",STR0049    		,,nTamDescr,,,"LEFT",,"LEFT") //"DescriÁ„o Produto"
		...
		oCell := TRCell():New(oSection51,"TOTBON","QRYSQL",STR0013  		,GetSx3Cache("TFY_TOTBON", "X3_PICTURE"),GetSx3Cache("TFY_TOTBON", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"BonificaÁıes"
	...
	oCellQbr := TRCell():New(oSection60,"IDENT","QRYSQL",""              ,,nTamIdent,,,"LEFT",,"LEFT")
		...
		oSection61 := TRSection():New(oSection60, STR0031, /*<uTable> */, /*<aOrder>*/ , /*<lLoadCells>*/ , /*<lLoadOrder>*/ , /*<uTotalText>*/ STR0058,/*<lTotalInLine .T.*/ , /*<lHeaderPage> */.f., /*<lHeaderBreak>*/ .t. , /*<lPageBreak>*/ .f. , /*<lLineBreak>*/ ,/* <nLeftMargin>*/ 15 , /*<lLineStyle> */, /*<nColSpace>*/ , /*<lAutoSize> */, /*<cCharSeparator>*/ , /*<nLinesBefore> */, /*<nCols> */, /*<nClrBack> */, /*<nClrFore> */, /*<nPercentage> */ )//Recursos Humanos //"Total LocaÁ„o de Equipamentos" //"LocaÁ„o de Equipamentos"
		oSection61:SetHeaderSection(.T.)
		oCell := TRCell():New(oSection61,"PRDCOD","QRYSQL",STR0045         	,,nTamProd,,,"LEFT",,"LEFT") //"CÛdigo"
		oCell := TRCell():New(oSection61,"PRDDSC","QRYSQL",STR0049    		,,nTamDescr,,,"LEFT",,"LEFT") //"DescriÁ„o Produto"
		...
		oCell := TRCell():New(oSection61,"MODCOB"	,"QRYSQL",STR0059			 	,,nTamCob,,{|| IIF((nPos := aScan(aModCob, {|m| AllTrim(m[1]) == Alltrim(QRYSQL->MODCOB)})) > 0,aModCob[nPos, 2],"")},"LEFT",,"LEFT") //"CobranÁa"
		...
		oCell := TRCell():New(oSection61,"TOTBON"	,"QRYSQL",STR0013		      	,GetSx3Cache("TFZ_TOTAL", "X3_PICTURE"),GetSx3Cache("TFZ_TOTAL", "X3_TAMANHO"),,,"LEFT",,"LEFT") //"BonificaÁıes"
	...
	oCellQbr := TRCell():New(oSection70,"IDENT","QRYSQL",""              ,,nTamIdent,,,"LEFT",,"LEFT")
		...
		oCell := TRCell():New(oSection71,"PRDCOD","QRYSQL",STR0045         	,,nTamProd,,,"LEFT",,"LEFT") //"CÛdigo"
		oCell := TRCell():New(oSection71,"PRDDSC","QRYSQL",STR0049    		,,nTamDescr,,,"LEFT",,"LEFT") //"DescriÁ„o Produto"
	...
	If lImpImp
		...
		oCell := TRCell():New(oSection00,"DESCR","QRYSQL",""	          ,, 30,,,"LEFT",,"LEFT")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            //"CÛdigo"
		...
		oCell := TRCell():New(oSection01,"SIGLA","QRYSQL","Sigla Imposto"	          ,, 4,,,"LEFT",,"LEFT")                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            //"CÛdigo"
		oCell := TRCell():New(oSection01,"BASE","QRYSQL","Base C·lculo"		      ,cImpPic,nTamImp,,,"LEFT",,"LEFT") //"Desc. Local"
	...
	EndIf
	If lTWX
		oSection42 := TRSection():New(oSection41, '',,,,,,,,,,,13)//"Conte˙do do Kit"
		
		oCell := TRCell():New(oSection42,"PRDCOD","QRYSQL",STR0045         	,,nTamProd,,,"LEFT",,"LEFT") //"CÛdigo"
		oCell := TRCell():New(oSection42,"PRDDSC","QRYSQL",STR0049    		,,nTamDescr,,,"LEFT",,"LEFT") //"DescriÁ„o Produto"
		...
		oSection52 := TRSection():New(oSection51, ' ',,,,,,,,,,,13)//"Conte˙do do Kit"
		oCell := TRCell():New(oSection52,"PRDCOD","QRYSQL",STR0045         	,,nTamProd,,,"LEFT",,"LEFT") //"CÛdigo"
		oCell := TRCell():New(oSection52,"PRDDSC","QRYSQL",STR0049    		,,nTamDescr,,,"LEFT",,"LEFT") //"DescriÁ„o Produto"
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±⁄ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¬ƒƒƒƒƒƒ¬ƒƒƒƒƒƒƒƒƒƒø±±
±±≥FunáÑo    ≥ RELIMP   ≥ Autor ≥ Heimdall B. Castro    ≥ Data ≥ 04/09/07 ≥±±
±±¿ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ¡ƒƒƒƒƒƒ¡ƒƒƒƒƒƒƒƒƒƒŸ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂﬂ*/

Static Function RELIMP(oReport, lImpImp, aIdent, lTWX)
...
BeginSql alias "QRYSQL"
	...
	FROM 
		...
		INNER JOIN %table:SC5% SC5  ON ( (  ( SC5.C5_MDCONTR = TFL.TFL_CONTRT AND SC5.C5_MDPLANI = TFL.TFL_PLAN AND SC5.C5_MDNUMED = TFW.TFW_NUMMED AND TFF.TFF_COBCTR <> '2')  OR 
										 ...
										 ) AND   SC5.C5_FILIAL = %xfilial:SC5%   AND SC5.C5_CLIENTE BETWEEN %Exp:MV_PAR03% AND %Exp:MV_PAR05%  AND SC5.C5_LOJACLI BETWEEN %Exp:MV_PAR04% AND %Exp:MV_PAR06%  AND  SC5.%notDel%  ) 
		INNER JOIN %table:ABS% ABS ON (ABS.ABS_LOCAL = TFL.TFL_LOCAL  AND ABS.ABS_FILIAL = %xfilial:ABS% AND ABS.ABS_LOCAL BETWEEN %Exp:MV_PAR07% AND %Exp:MV_PAR08% AND ABS.%notDel%)
	...
	WHERE
			TFV.TFV_FILIAL =  %xfilial:TFV%  
			AND TFV.TFV_CODIGO BETWEEN %Exp:MV_PAR01% AND %Exp:MV_PAR02%
			AND TFV.TFV_DTAPUR BETWEEN %Exp:MV_PAR09% AND %Exp:MV_PAR10%
			AND TFV.%notDel%
 ...
 UNION
	...
	FROM 
		...
		INNER JOIN %table:TFV% TFV  ON (TFV.TFV_CODIGO = TFW.TFW_APURAC AND  TFV.TFV_FILIAL = %xfilial:TFV% AND  TFV.%notDel% AND 
										TFV.TFV_CODIGO BETWEEN %Exp:MV_PAR01% AND %Exp:MV_PAR02%  )
...
While !QRYSQL->(EOF())
	...
	lImpImp := MV_PAR11 == 1
	If lImpImp //Se imprimir impostos e for uma mediÁ„o fora do contrato nao imprime imposto
		TCV->(DbSetOrder(1))
		lImpImp := !TCV->(DbSeek(xFilial("TCV") + PadR(QRYSQL->CODMED, TamSX3("TCV_NUMAPU")[1]) ))
	EndIf
	   ...
	   For nY := 1 to nFisGetSC5
		...
		Do While SC6->(!Eof() .AND. C6_NUM = cPedido)
			...
			MaFisAdd(	SC6->C6_PRODUTO,;  	// 1-Codigo do Produto ( Obrigatorio )
		            	...
		            	,;
		            	,;
		            	Iif(Len(Alltrim(SC6->C6_CLASFIS))==3,SC6->C6_CLASFIS,""),; // 28-ClassificaÁ„o fiscal
						,; //29
						,; //30
						,; //31
						,; //32
						SC6->C6_OPER) // 33 - Tipo de OperaÁ„o.
			...
			If ( SC5->C5_INCISS == "N" .And. SC5->C5_TIPO == "N")
				If ( SF4->F4_ISS=="S" )
					...
					If lRndIss
						//Quando configurado para arredondar ISS È nescessario calcular ISS por item
						//conforme ja realizado na funÁao MaPvPrcIt (MATA461)
