...
@return		oReport, 	Object,	Objeto do relatório de Presença no Posto
...
Presença no Posto - monta as Sections para impressão do relatório
...
oReport   := TReport():New("TECR970",STR0001,cPerg,{|oReport| Rt970Print(oReport, cPerg, cAlias1)},STR0001,,,.T.) //"Presença no Posto"
...
//Totalizador Horas Reforço
oSum3 := TRFunction():New(oSection4:Cell("HRREFOR" ),"Tot3","TIMESUM",,STR0011,,,.T.) //"Total Horas Reforço"
...
Presença no Posto - monta a Query e imprime o relatorio de acordo com os parametros
...
Verifica se preenche a coluna conforme o tipo de alocação

@sample 	Atr970Tot(cAlias1)

@param		cAlias1,	String,	Nome do alias da Query do relatório 
			cTip,		String,	Qual é o tipo do campo
